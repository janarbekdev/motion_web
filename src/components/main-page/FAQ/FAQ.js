                    ...
                    <h1>Отзывы студентов</h1>
                        ...
                        setSelected4(false)}} style={{height:selected ? "150px" : "",transition:"1s"}}  className="faq--acor__card">
                                  ...
                                  <div className="faq--acor__card--acc">
                                      <MdArrowBackIosNew className="faq--acor__card--acc__rotate" style={{ color:"black", transform: selected ? "rotate(270deg)" : "rotate(90deg)", marginRight:"20px", marginTop:"-10px", }}/>
                            <h1>Нужны ли начальные знания для учёбы?</h1>
                             <p>
                                 ...
                                 repellat? ipsum dolor sit amet, consectetur a
                                 dipisicing elit. Doloremque, suscipit.</p>
